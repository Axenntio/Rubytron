...
#define SPR_MAXIMISE_FULL_HEIGHT 5
extern unsigned char spr_maximise_full[SPR_MAXIMISE_FULL_HEIGHT];

#define SPR_CLOSE_MINIMAL_HEIGHT 3
extern unsigned char spr_close_minimal[SPR_CLOSE_MINIMAL_HEIGHT];

#define SPR_MAXIMISE_MINIMAL_HEIGHT 3
extern unsigned char spr_maximise_minimal[SPR_MAXIMISE_MINIMAL_HEIGHT];